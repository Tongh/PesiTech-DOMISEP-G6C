...
<body>
  ...
  <body>
  	...
  	<div id="DIYbody">
  			<div id="info_contact">
  				<p>
  					<h3> Un problème avec le service ou votre matériel ?</h3>
  			...
  			<figure id="form_assist">
  				<form method="post" action="assistance.php">
  					<label> <span class="txtq"> <strong> Par mail en remplissant le formulaire ci-dessous : </strong></span></strong> </label>
